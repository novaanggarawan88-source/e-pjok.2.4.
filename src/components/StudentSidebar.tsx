  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 pb-3 border-b border-slate-100 dark:border-slate-800 lg:hidden shrink-0">
        ...
        {/* Navigation Menu (Hanya menu yang scroll jika layar pendek) */}
        ...
        {/* Bottom Section: Info Akun & Tombol Keluar Terkunci di Paling Bawah */}
        <div className="p-4 border-t border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0 space-y-3">
